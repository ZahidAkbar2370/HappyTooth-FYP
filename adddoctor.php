...
<a href="dashboard.php" class="btn btn-success">Back To Doctor</a>
</div>
  <div class="mainfull">
    <h1>Add a Doctor</h1>
    <p>Please fill in the detail below and click submit to add a doctor in the Clinic.</p>
...
<div class="contactdiv">
  ...
  <input type="text" id="degree" name="degree" placeholder="Enter Doctor Degree ...">
