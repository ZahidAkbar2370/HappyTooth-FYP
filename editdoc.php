...
if (isset($_POST['updatedoc'])) {
      ...
      if ($pwd == $pwdconfirm) {
  $sql = "update users set username = '$name', degree = '$degree', password = '$pwd', role = 'doctor' where id='$id';";
...
<div class="contactdiv">
  ...
  <input type="text" id="name" name="name" placeholder="Enter Doctor Name ..." value="<?php echo $row['username']; ?>">

  <label for="name">Degree:</label>
  <input type="text" id="degree" name="degree" placeholder="Enter Doctor Degree ..." value="<?php echo $row['degree']; ?>">
  ...
  <input type="submit" value="Submit" name="updatedoc" id="updatedoc">
  </form>
</div>
</div>
  </div>
